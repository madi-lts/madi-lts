...
date: 2020-04-28
abstract: How can we use a fitting routine to categorize data in a binary classification problem?
...
![](/assets/images/2020-04-28/2d-category-data.png)
![](/assets/images/2020-04-28/2d-category-fit.png)
